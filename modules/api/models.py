...
class AlphaTxt2ImgRequest(BaseModel):
    ...
    steps: int | None = Field(default=None, title="Steps", description="Number of sampling steps (default: 20)")
    sampler_name: str | None = Field(default=None, title="Sampler", description="Sampler name (default: DPM++ 2M SDE)")
    scheduler: str | None = Field(default=None, title="Scheduler", description="Scheduler (default: Karras)")
    cfg_scale: float | None = Field(default=None, title="CFG Scale", description="Classifier Free Guidance scale (default: 5)")
    width: int | None = Field(default=None, title="Width", description="Image width (default: 1024)")
    height: int | None = Field(default=None, title="Height", description="Image height (default: 1024)")
    batch_size: int | None = Field(default=None, title="Batch Size", description="Number of images to generate (default: 1)")
    n_iter: int | None = Field(default=None, title="Iterations", description="Number of iterations (default: 1)")
    restore_faces: bool | None = Field(default=None, title="Restore Faces", description="Restore faces (default: False)")
    tiling: bool | None = Field(default=None, title="Tiling", description="Tiling (default: False)")
    subseed: int | None = Field(default=None, title="Subseed", description="Subseed (default: -1)")
    subseed_strength: float | None = Field(default=None, title="Subseed Strength", description="Subseed strength (default: 0)")
    seed_resize_from_h: int | None = Field(default=None, title="Seed Resize From Height", description="Seed resize from height (default: -1)")
    seed_resize_from_w: int | None = Field(default=None, title="Seed Resize From Width", description="Seed resize from width (default: -1)")
    eta: float | None = Field(default=None, title="Eta", description="Eta for ancestral samplers")
    s_churn: float | None = Field(default=None, title="S Churn", description="S churn")
    s_tmax: float | None = Field(default=None, title="S Tmax", description="S tmax")
    s_tmin: float | None = Field(default=None, title="S Tmin", description="S tmin")
    s_noise: float | None = Field(default=None, title="S Noise", description="S noise")
